...
import com.petshop.event.EventMenu;
import com.petshop.event.EventMenuSelected;
import com.petshop.event.EventShowPopupMenu;
import com.petshop.swing.model.ModelMenu;
import com.petshop.swing.MenuAnimation;
import com.petshop.swing.MenuItem;
import com.petshop.swing.scrollbar.ScrollBarCustom;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void addMenu(ModelMenu menu) {
        ...
        panel.add(menuItem, "h 40!");  // Tăng chiều cao của MenuItem lên 60 pixel hoặc giá trị lớn hơn
    }
    ...
    private void initComponents() {
        ...
        profile1 = new com.petshop.component.Profile();
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, new Color(255, 182, 193), getWidth(), 0, new Color(93, 58, 196));
        g2.setPaint(gra);
    ...
    private com.petshop.component.Profile profile1;
